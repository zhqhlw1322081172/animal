...
class Ajax{
	...
	static ajax1811(url,method,param,isAsync,func){
		//1、创建对象
	...
	//返回值：无
	//static：表示静态的意思，
	//static修饰的函数，叫作类的函数,直接static用类名调用。
	//用static修饰的函数一般是工具性的函数。跟对象没有关系。
	static ajax1811ByObjAndDefault(obj){
		//默认值
		let defaultObj = {
			url:"#",
			method:"get",
